...
public class ConstructorLogic {
     ...
     *
     * @param cross1 startcross
     * @param cross2 endcross
     * @param id     the id of the player that wants to place the street
     * @return boolean
     */
     ...
     *
     * @param cross position of settlement
     * @param id    the id of the player that wants to place the settlement
     * @return boolean
     */
     ...
     *
     * @param cross position of the city
     * @param id    the id of the player that wants to place the city
     * @return boolean
     */
