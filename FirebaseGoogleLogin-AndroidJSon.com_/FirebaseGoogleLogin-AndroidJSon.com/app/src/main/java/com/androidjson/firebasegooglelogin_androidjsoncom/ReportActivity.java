...
public class ReportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item("WORK", "MAKE WORK REPORT", "value ", R.drawable.report_logo));
        ...
        //Create an adapter
        adapter = new RecyclerViewAdapter(ReportActivity.this, items);
        ...
        adapter.setOnItemClickListener(new RecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Toast.makeText(ReportActivity.this, getResources().getString(R.string.clicked_item, items.get(position).getInfo()), Toast.LENGTH_SHORT).show();
        ...
        submit_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!value_edittext.getText().toString().equals("")) {
                    ...
                    Toast.makeText(ReportActivity.this, getResources().getString(R.string.cant_be_empty), Toast.LENGTH_SHORT).show();
                }
            }
        });
